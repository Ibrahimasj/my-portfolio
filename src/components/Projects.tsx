...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Dashboard admin untuk e-commerce dengan fitur analytics, manajemen produk, dan visualisasi data penjualan.',
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-zinc-400">
            Beberapa proyek yang sudah saya kerjakan, mulai dari sistem
            informasi hingga API backend.
          </p>
        </motion.div>
        ...
        >
          {projects.map((project) => (
            <motion.div
              key={project.title}
              variants={item}
              className="group flex flex-col rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 transition-colors hover:border-emerald-500/30 hover:bg-zinc-900"
            >
              {/* Title */}
